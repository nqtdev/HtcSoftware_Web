  ...
  return (
    <div className='container m-auto w-full xl:w-10/12'>
      ...
      <section className='text-center mt-48'>
        <h1 className='text-[#223464] font-mulish text-5xl font-bold'>Về HTC SOFTWARE</h1>
        ...
        <div className='lg:w-3/5 m-auto'>
          <span className='font-sans text-gray-700 text-sm xl:text-xl'>
            Đây chính là thông điệp quan trọng nhất mà Ban lãnh đạo và tất cả cán bộ nhân viên HTC
            hướng đến. Với mục tiêu "Phục vụ khách hàng tốt nhất với những gì mình có", HTC luôn nỗ
            lực, cố gắng thay đổi và hoàn thiện hơn mỗi ngày để khách hàng luôn nhận được{' '}
            <span className='font-bold text-sm xl:text-xl'> "dịch vụ và giá trị tốt nhất".</span>
          </span>
        </div>
      </section>
      {/* Tầm nhìn - Sử mệnh  */}
