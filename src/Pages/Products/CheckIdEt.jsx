                ...
                <div className="m-auto grid gap-3 p-5 lg:w-2/3 lg:grid-cols-2">
                    <div>
                        ...
                        <p className="font-roboto text-main-colors">
                            CheckID-ET100 được thiết kế để đáp ứng nhu cầu bảo
                            mật cao mà không làm giảm sự tiện lợi. Thiết bị này
                            có cổng USB loại A female, cho phép kết nối với máy
                            tính. Nó hỗ trợ nhiều loại cảm biến sinh trắc học
                            như SecuGen, SupreMa, ZKTeco và Morpho. Việc chọn
                            cảm biến sinh trắc học nên dựa trên yêu cầu của
                            khách hàng.
                        </p>
                    </div>
                    <div className="mt-3">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="ptb-specification">
                                    ...
                                    CDMA BC0,
                                    <br />
                                    TDD-LTE band 34/39/40/41 (38) FDD LTE band
                                    1/3/5/8
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td className="ptb-specification">
                                    300dpi resolution, wide angle multiple
                                    spectral lights <br />
                                    High-definition scan tube, high-definition
                                    image
                                </td>
                            </tr>
                            <tr>
